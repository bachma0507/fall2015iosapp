...
-(void)fetchMemberFunctions{
    ...
    @try {
        ...
        if([[self.txtUsername text] isEqualToString:@""]) {
            ...
            NSString *post =[[NSString alloc] initWithFormat:@"sess=CN-CANADA-ON-0415&custcd=%@",[self.txtUsername text]];
            
            NSLog(@"PostData: %@",post);
            
            NSString * webURL = [[NSString alloc] initWithFormat:@"https://webservice.bicsi.org/json/reply/MobFunctions?sess=CN-CANADA-ON-0415&custcd=%@", [self.txtUsername text]];
